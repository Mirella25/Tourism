...
import 'package:tourism_app/controller/guide/login_guide_controller.dart';
...
class LogInGuide extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Get.lazyPut(() => LogInGuideControllerImp());

    Size size = MediaQuery.of(context).size;
    return Scaffold(
      body: SafeArea(
        child: Obx(
          () => Get.find<LogInGuideControllerImp>().isloading.value == true
              ? Center(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Form(
                                    key:
                                        Get.find<LogInGuideControllerImp>().key,
                                    child: Column(children: [
                                      CustomTextField(
                                          controller: Get.find<
                                                  LogInGuideControllerImp>()
                                              .email,
                                          labelText: "48".tr,
                                      ...
                                      CustomTextField(
                                          ...
                                          icon:
                                              Get.find<LogInGuideControllerImp>()
                                                          .isShowPass
                                                          .value ==
                                                      false
                                                  ? Icons.visibility
                                ...
                                CustomAuthButton(
                                    onPressed: () async {
                                      if (Get.find<LogInGuideControllerImp>()
                                          .key
                                          .currentState!
                                          .validate()) {
                                        Get.find<LogInGuideControllerImp>()
                                ...
                                UnderPart(
                                  ...
                                  navigatorText: "57".tr,
                                  onTap: () {
                                    Get.offAllNamed(AppRoute.registerGuide);
                                  },
                                ),
                                const SizedBox(
                                  height: 20,
