...
class DrawerGuideScreen extends StatelessWidget {
  const DrawerGuideScreen({super.key});
        ...
        child: Column(
          children: [
              ...
              () => Row(children: [
                SizedBox(
                  ...
                  child: ClipRRect(
                    ...
                    child: Image.network(
                      Get.find<ProfileGuideControllerImp>().userData['photo'] !=
                                  null &&
                              Get.find<ProfileGuideControllerImp>()
                                      .userData['photo'] !=
                                  ''
                          ? "http://10.0.2.2:8000${Get.find<ProfileGuideControllerImp>().userData['photo']}"
                ...
                Column(children: [
                  Text(
                    Get.find<ProfileGuideControllerImp>().userData['name'] ??
                        "74".tr,
                    style: const TextStyle(
                        fontSize: 20, fontWeight: FontWeight.bold),
                  ),
                  Text(
                    Get.find<ProfileGuideControllerImp>().userData['email'] ??
                        "75".tr,
            ...
            ListTile(
              ...
              onTap: () async {
                Get.toNamed(AppRoute.settingsGuide);
              },
              leading: const Icon(
                Icons.settings,
                color: Colors.white,
            ...
            ListTile(
              tileColor: Colors.white.withOpacity(0.1),
              onTap: () async {
                Get.find<LogOutGuideControllerImp>().logOut();
              },
              leading: const Icon(
